...
from easyeditor.trainer.llava.model.builder import load_pretrained_model
...
if __name__ == '__main__':
    ...
    model = load_pretrained_model(model_path="../hugging_cache/llava-v1.5-7b", device="cuda")
    ...
    tokenizer = AutoTokenizer.from_pretrained("../hugging_cache/llava-v1.5-7b")
