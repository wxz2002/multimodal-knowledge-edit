...
if __name__ == '__main__':
    ...
    rome_stability_original_answer_accs = get_accs(rome_stability_original_answer_results)
    ...
    if rome_stability_original_answer_acc > rome_stability_no_answer_acc:
        print('结论3: True')
    else:
        print('结论3: False')
    
    if ft_stability_unimodal_acc < ft_stability_multimodal_acc:
        print('结论4: True')
    else :
        print('结论4: False')
