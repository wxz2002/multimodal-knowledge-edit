...
@dataclass
class ROMEMultimodalHyperParams(HyperParams):
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and config['alg_name'] == 'ROME') or print(f'ROMEMultiModalHyperParams can not load from {hparams_name_or_path}, '
                                                f'alg_name is {config["alg_name"]} ')
        return cls(**config)